...
lr_scheduler_params = {"mode": "min", "factor": 0.5, "patience": 30}
...
ar_model_params = {"encoding_dim": 256, "output_dim": 256}
w_params = {
    "encoding_dim": 256,
...
params_train_dataset = {"file_dir": "LibriSpeech/train-clean-100"}
params_validation_dataset = {"file_dir": "LibriSpeech/train-clean-100"}
params_test_dataset = {"file_dir": "LibriSpeech/train-clean-100"}


# The hyperparameters for training and validation (arguments for torch.utils.data.DataLoader object)
params_train = {"batch_size": batch_size, "shuffle": True, "drop_last": True}

# The hyperparameters for testing (arguments for torch.utils.data.DataLoader object)
params_test = {"batch_size": batch_size, "shuffle": False, "drop_last": True}
